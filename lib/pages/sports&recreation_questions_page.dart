...
class SportsRecreationQuestionsPage extends StatefulWidget {
  @override
  _SportsRecreationQuestionsPageState createState() => _SportsRecreationQuestionsPageState();
}
...
Future<List<Map<String, dynamic>>> getTenRandomSportsRecreationQuestions() async {
  try {
    final snapshot = await FirebaseFirestore.instance
        .collection('sports&recreation_questions')
        .get();

    print("🎯 Total fetched sports & recreation questions: ${snapshot.docs.length}");
    ...
    print("❌ Error getting sports & recreation questions: $e");
    return [];
  }
}

class _SportsRecreationQuestionsPageState extends State<SportsRecreationQuestionsPage> {
  ...
  Future<void> loadQuestions() async {
    print("🏋️ Loading sports & recreation questions...");
    setState(() => isLoading = true);

    questions = await getTenRandomSportsRecreationQuestions();

    print("✅ Finished loading sports & recreation. Total loaded: ${questions.length}");
...
void restartQuiz() {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(title: Text("Sports & Recreation Questions")),
