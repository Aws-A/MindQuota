...
class LanguageCommunicationQuestionsPage extends StatefulWidget {
  @override
  _LanguageCommunicationQuestionsPageState createState() => _LanguageCommunicationQuestionsPageState();
}
...
Future<List<Map<String, dynamic>>> getTenRandomLanguageCommunicationQuestions() async {
  try {
    final snapshot = await FirebaseFirestore.instance
        .collection('language&communication_questions')
        .get();

    print("🗣️ Total fetched Language & Communication questions: ${snapshot.docs.length}");
    ...
    print("❌ Error getting Language & Communication questions: $e");
    return [];
  }
}

class _LanguageCommunicationQuestionsPageState extends State<LanguageCommunicationQuestionsPage> {
  ...
  Future<void> loadQuestions() async {
    print("🗣️ Loading Language & Communication questions...");
    setState(() => isLoading = true);

    questions = await getTenRandomLanguageCommunicationQuestions();

    print("✅ Finished loading Language & Communication questions. Total loaded: ${questions.length}");
