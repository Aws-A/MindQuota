...
class GeographyQuestionsPage extends StatefulWidget {
  @override
  _GeographyQuestionsPageState createState() => _GeographyQuestionsPageState();
}
...
Future<List<Map<String, dynamic>>> getTenRandomGeographyQuestions() async {
  try {
    final snapshot = await FirebaseFirestore.instance
        .collection('geography_questions')
        .get();

    print("🗺️ Total fetched geography questions: ${snapshot.docs.length}");
    ...
    print("❌ Error getting geography questions: $e");
    return [];
  }
}

class _GeographyQuestionsPageState extends State<GeographyQuestionsPage> {
  ...
  Future<void> loadQuestions() async {
    print("🗺️ Loading geography questions...");
    setState(() => isLoading = true);

    questions = await getTenRandomGeographyQuestions();

    print("✅ Finished loading geography questions. Total loaded: ${questions.length}");
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(title: Text("Geography Questions")),
    ...
    if (questions.isEmpty) {
      return Scaffold(
        appBar: AppBar(title: Text("Geography Questions")),
        body: Center(child: Text("No geography questions found.")),
      );
    }
