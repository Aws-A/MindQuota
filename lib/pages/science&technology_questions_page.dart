...
class ScienceTechnologyQuestionsPage extends StatefulWidget {
  @override
  _ScienceTechnologyQuestionsPageState createState() => _ScienceTechnologyQuestionsPageState();
}
...
Future<List<Map<String, dynamic>>> getTenRandomScienceTechQuestions() async {
  try {
    final snapshot = await FirebaseFirestore.instance
        .collection('science&technology_questions')
        .get();

    print("🔬 Total fetched Science & Technology questions: ${snapshot.docs.length}");
    ...
    print("❌ Error getting Science & Technology questions: $e");
    return [];
  }
}

class _ScienceTechnologyQuestionsPageState extends State<ScienceTechnologyQuestionsPage> {
  ...
  Future<void> loadQuestions() async {
    print("🔬 Loading Science & Technology questions...");
    setState(() => isLoading = true);

    questions = await getTenRandomScienceTechQuestions();

    print("✅ Finished loading Science & Technology questions. Total loaded: ${questions.length}");
...
void restartQuiz() {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(title: Text("Science & Technology Questions")),
