...
class BusinessEconomicsQuestionsPage extends StatefulWidget {
  @override
  _BusinessEconomicsQuestionsPageState createState() => _BusinessEconomicsQuestionsPageState();
}
...
Future<List<Map<String, dynamic>>> getTenRandomBusinessQuestions() async {
  try {
    final snapshot = await FirebaseFirestore.instance
        .collection('business&economics_questions')
        .get();

    print("💼 Total fetched business questions: ${snapshot.docs.length}");
    ...
    print("❌ Error getting business questions: $e");
    return [];
  }
}

class _BusinessEconomicsQuestionsPageState extends State<BusinessEconomicsQuestionsPage> {
  ...
  Future<void> loadQuestions() async {
    print("💼 Loading business & economics questions...");
    setState(() => isLoading = true);

    questions = await getTenRandomBusinessQuestions();

    print("✅ Finished loading business questions. Total loaded: ${questions.length}");
...
void restartQuiz() {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(title: Text("Business & Economics Questions")),
    ...
    if (questions.isEmpty) {
      return Scaffold(
        appBar: AppBar(title: Text("Business & Economics Questions")),
        body: Center(child: Text("No business & economics questions found.")),
      );
    }
