...
class HistoryQuestionsPage extends StatefulWidget {
  @override
  _HistoryQuestionsPageState createState() => _HistoryQuestionsPageState();
}
...
Future<List<Map<String, dynamic>>> getTenRandomHistoryQuestions() async {
  try {
    final snapshot = await FirebaseFirestore.instance
        .collection('history_questions')
        .get();

    print("📜 Total fetched history questions: ${snapshot.docs.length}");
    ...
    print("❌ Error getting history questions: $e");
    return [];
  }
}
...
class _HistoryQuestionsPageState extends State<HistoryQuestionsPage> {
  ...
  Future<void> loadQuestions() async {
    ...
    questions = await getTenRandomHistoryQuestions();

    print("✅ Finished loading history questions. Total loaded: ${questions.length}");
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(title: Text("History Questions")),
    ...
    if (questions.isEmpty) {
      return Scaffold(
        appBar: AppBar(title: Text("History Questions")),
        body: Center(child: Text("No history questions found.")),
      );
    }
